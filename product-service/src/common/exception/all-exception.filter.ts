    ...
    constructor(private config: ConfigService, private readonly logger: LoggerService) {}
        ...
        try {
            ...
            if (exception instanceof HttpException) {
                ...
                errorResponse.code = (typeof exceptionResponse === 'object' && exceptionResponse['errorCode']) || errorResponse.code;
                errorResponse.errors = (typeof exceptionResponse === 'object' && exceptionResponse['errors']) || errorResponse.errors;
            }
